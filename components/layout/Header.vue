...
<template>
  <div
    class="
      bg-pamred-100 md:bg-grayshit-500 md:bg-opacity-90
      shadow-md
      max-w-full
      block
      w-full
    ...
    <div class="max-w-9xl mx-auto px-2 md:px-6 lg:px-8 md:mt-4">
      <div class="relative flex items-center justify-between h-16">
        ...
        >
          ...
          <div
            :class="`z-40 block h-full top-0 left-0 bg-pamred-100 md:bg-transparent fixed md:static transform transition duration-500 ease-in-out md:translate-x-0 p-8 md:p-0 md:block ${
          ...
          <div
            :class="`inset-0 w-full md:invisible fixed h-full z-30 block ${
              toggleNav ? 'visible bg-gray-100 bg-opacity-0' : 'invisible'
            }`"
            @click="toggleOff"
          ></div>
        </div>
